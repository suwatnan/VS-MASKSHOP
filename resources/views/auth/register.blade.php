            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('G-Mail Address') }}</label>

                            <div class="col-md-6">
                                <input id="gmail" type="text" class="form-control @error('gmail') is-invalid @enderror" name="gmail" required autocomplete="gmail">
