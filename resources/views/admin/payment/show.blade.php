                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $payment->paymentID }}</td>
                                    </tr>
                                    <tr><th> PaymentID </th><td> {{ $payment->paymentID }} </td></tr><tr><th> OrderID </th><td> {{ $payment->orderID }} </td></tr><tr><th> Price </th><td> {{ $payment->price }} </td></tr>
                                </tbody>
                            </table>
                        </div>
